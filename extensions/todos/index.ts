 ...
 * Todo Extension
 *
 * File-based todo management system storing todos in .pi/todos directory.
 * Each todo is a markdown file with JSON front matter.
 *
 * Commands:
 * - /todos - Open visual todo manager
 *
 * Tools:
